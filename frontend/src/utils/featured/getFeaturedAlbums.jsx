...
import { featuredAlbums } from "../getCollection";
...
const featuredCards = () => {
  ...
  const featured = featuredAlbums(allAlbums);
      ...
      <div className="flex overflow-x-auto gap-4 pb-2 snap-x snap-mandatory scrollbar-hide">
        {featured.map((album, index) => (
          <div
            ...
            className="card shadow-sm flex-shrink-0 snap-start p-2 relative group hover:bg-base-300"
          >
            {/* Album cover wrapper */}
            <div className="relative w-30 h-30  md:w-40 md:h-40 overflow-hidden rounded-xl">
              ...
              <img
                ...
                alt="play icon"
                className="size-11 cursor-pointer md:size-12 invert p-3 bg-pink-500 rounded-full absolute bottom-[-3rem] right-2 
